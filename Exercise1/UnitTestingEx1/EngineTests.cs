...
namespace UnitTestingEx1
{
    public class EngineTests
    {
        ...
        public void Creating_Engine_Should_Throw_Exception(string Model,
        ...
        [InlineData(-148000)]
        [InlineData(148110)]
        public void Change_Engine_Weight_Should_Throw_Exception(int ChangeWeight)
        {
            //Given - Arrange
            Engine actual = new Engine("CP 8002", "12345", 147000, 4400);
            actual.InService = false;
        ...
        public void Change_InService_Engine_Weight_Should_Throw_Exception(int ChangeWeight)
        {
            //Given - Arrange
            Engine actual = new Engine("CP 8002", "12345", 147000, 4400);
        ...
        [InlineData(2400)]
        [InlineData(6400)]
        public void Change_Engine_HorsePower_Should_Throw_Exception(int ChangeHorsePower)
        {
            //Given - Arrange
            //Given - Arrange
            Engine actual = new Engine("CP 8002", "12345", 147000, 4400);
        ...
        public void Change_InService_Engine_HorsePower_Should_Throw_Exception(int ChangeHorsePower)
        {
            //Given - Arrange
            //Given - Arrange
            Engine actual = new Engine("CP 8002", "12345", 147000, 4400);
